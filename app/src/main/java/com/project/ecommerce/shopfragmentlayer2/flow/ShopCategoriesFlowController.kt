...
class ShopCategoriesFlowController()
    : ShopCategoriesFlow {
    override fun openShopFragmentLayer3(supportFragmentManager: FragmentManager?, type: String, name: String, id: String) {
        if (supportFragmentManager?.findFragmentByTag("ShopFragmentLayer3") == null){
            ...
            supportFragmentManager?.commit {
                add(R.id.shop_layer2_fragment, fragment, "ShopFragmentLayer3")
            }
        }
    }
}